...
a = (max_fr - min_fr) / 2; % Amplitude
p = 2 * pi / 12; % Period of 2 pi / p in times
f = a;
...
for p = 0.01:3.01 % Test different periods
...
for a = 0.01:3:10.01 % Test different max fishing rates
...
for f = 1.5:0.25:2 % Test different base fishing rates
